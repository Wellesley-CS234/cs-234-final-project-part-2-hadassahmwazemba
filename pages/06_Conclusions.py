...
st.write("""
         ...
         were largely accurate. However, some classification limitations remain. The\
         model was trained and applied only to articles within the WikiProject Africa dataset, \
         meaning that additional Africa-related articles present in the broader DPDP dataset may not \
         have been captured.

         There are also important limitations to this analysis. Using the English Wikipedia as\
